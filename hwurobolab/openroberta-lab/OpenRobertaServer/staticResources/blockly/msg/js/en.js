...
Blockly.Msg.MENU_CODE_REFRESH_TOOLTIP = "Refresh the source code, if you have changed the Program.";
...
Blockly.Msg.MENU_MESSAGE_DOWNLOAD = "YIPEE!!! Robot will move in a bit...";
...
Blockly.Msg.MENU_TOOLBOX = "HWURobolab-Blocks";
Blockly.Msg.MENU_TOOLBOX_BEGINNER = "HWURobolab-Blocks beginner";
Blockly.Msg.MENU_TOOLBOX_EXPERT = "HWURobolab-Blocks expert";
...
Blockly.Msg.MODE_PRESSED = "active";
...
Blockly.Msg.MOTOR_BACKWARD = "input (-) before the speed for reverse";
...
Blockly.Msg.MOTOR_DEGREE = "turns (100 = 10 turns)";
Blockly.Msg.MOTOR_DISTANCE = "time (decisecond)";
...
Blockly.Msg.MOTOR_LEFT = "right turn | obst. dist (cm)";
...
Blockly.Msg.MOTOR_RIGHT = "left turn | robot speed";
...
Blockly.Msg.POPUP_STARTUP_HELP = "Do you need help, or want to know about the National Robotarium?";
Blockly.Msg.POPUP_STARTUP_HELP_TEXT = "This Project is built in colloboration with The UK National Robotarium, check us now.";
...
Blockly.Msg.SENSOR_IS_PRESSED = "active?";
...
Blockly.Msg.SENSOR_TOUCH = "lidar sensor";
...
Blockly.Msg.TOUR1_DESCRIPTION01 = "Welcome,<br>click on  »next« and start a tour through the HWU Robolab.<br>I'll show you how you can program your robot with the Blocks.<br>You can end this tour all the time with a click on »X« in the right upper corner.";
